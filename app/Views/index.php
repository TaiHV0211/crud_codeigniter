...
<body class="app_version" data-spy="scroll" data-target="#navbarApp" data-offset="98">
    ...
    <header class="header header_style_01">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.html"><img src="/assets/user/images/logos/logo-app.png" alt="image"></a>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="big-tagline">
                        ...
                        <p class="lead">Appfast Mobile App hỗ trợ xem trước thời gian thực ứng dụng ngay khi bạn đang chỉnh sửa ứng dụng trên Bảng điều khiển (Dashboard). Bằng cách này, bạn có thể hình dung rõ ràng nhất ứng dụng của bạn khi hoạt động trên thiết bị thật sẽ như thế nào.</p>
                ...
                <div class="app_iphone_01 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.2s">
                    <img src="/assets/user/uploads/app_iphone_01.png" alt="" class="img-fluid">
                </div>
                <div class="app_iphone_02 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="/assets/user/uploads/app_iphone_02.png" alt="" class="img-fluid">
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end section -->
    ...
    <div id="features" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Appfast là nền tảng xây dựng ứng dụng di động, cho phép bạn xây dựng ứng dụng của mình mà không cần kiến thức về lập trình. Appfast tạo ứng dụng dựa trên các widget được định nghĩa sẵn cùng khả năng tùy chỉnh các thuộc tính như màu sắc, hình ảnh, liên kết... tùy thuộc vào mục đích của bạn. Appfast hỗ trợ xem trước thời gian thực ứng dụng mà bạn đang tạo bằng ứng dụng Appfast Mobile App.</p>
            </div><!-- end title -->
					...
					<ul class="features-left">
						...
						<li class="highlight lhgh" data-index="3">
							...
							<div class="fl-inner">
								...
								<p>Nhấn vào Quên mật khẩu trong trang Đăng nhập, thực hiện theo hướng dẫn để đặt lại mật khẩu mới.</p>
							</div>
						</li><!-- .highlight .left-row -->
					</ul>
				</div><!-- .row .left-row -->
				...
				<div class="highlights-phone col-lg-4 col-md-4 col-sm-12 col-xs-12 wht">
					...
					<div class="phone-holder">
					   ...
					   <div class="hgh-linner hgi" data-index="0">
							<img width="190" height="320" src="/assets/user/uploads/carousel_01.jpg" class="attachment-highlight wp-post-image" alt="screen" />    
						</div>
						<div class="hgh-linner hgi" data-index="1">
							<img width="234" height="398" src="/assets/user/uploads/carousel_02.jpg" class="attachment-highlight wp-post-image" alt="screensdst" />    
						</div>
						<div class="hgh-linner hgi" data-index="2">
							<img width="234" height="398" src="/assets/user/uploads/carousel_03.jpg" class="attachment-highlight wp-post-image" alt="screen_09" />    
						</div>
						<div class="hgh-rinner hgi" data-index="3">
							<img width="234" height="398" src="/assets/user/uploads/carousel_04.jpg" class="attachment-highlight wp-post-image" alt="screen_07" />    
						</div>
						<div class="hgh-rinner hgi" data-index="4">
							<img width="234" height="398" src="/assets/user/uploads/carousel_01.jpg" class="attachment-highlight wp-post-image" alt="screen_08" />    
						</div>
						<div class="hgh-rinner hgi" data-index="5">
							<img width="234" height="398" src="/assets/user/uploads/carousel_01.jpg" class="attachment-highlight wp-post-image" alt="screen_06" />    
						</div>
						<div class="hgh-rinner hgi" data-index="6">
							<img width="234" height="398" src="/assets/user/uploads/carousel_02.jpg" class="attachment-highlight wp-post-image" alt="screen_06" />    
						</div>
						<div class="hgh-rinner hgi" data-index="7">
							<img width="234" height="398" src="/assets/user/uploads/carousel_03.jpg" class="attachment-highlight wp-post-image" alt="screen_06" />    
						</div>
					</div>
				</div>
    ...
    <div id="screenshots" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Một số màn hình chức năng của ứng dụng, luôn hướng đến giao diện tốt nhất cho người dùng nên chúng tôi luôn luôn mong muốn người dùng có một trải nghiệm sử dụng tốt nhất</p>
            </div><!-- end title -->
            ...
            <div class="owl-screenshots owl-carousel owl-theme">
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_01.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_02.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_03.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_04.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_05.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                ...
                <div class="owl-screen">
                    <div class="service-widget">
                        <div class="post-media entry wow fadeIn">
                            <a href="/assets/user/uploads/screenshot_06.png" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
            ...
            <div class="row text-center">
                <div class="col-md-7 col-sm-12">
                    <div class="customwidget text-left">
                        ...
                        <p>
                            Hiện tại ứng dụng đã được tải lên các store lớn của các nền tảng IOS, Android và Amazon khách hàng có thể truy cập vào hệ thống store trên thiết bị thông minh và tải về dùng thử.
    ...
    <div id="pricing" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Ưu đãi tốt nhất <strong>chỉ với $39 trên 1 tháng!</strong> Ước tính doanh thu của bạn có thể phát triển đến 3.5 triệu $.<br> doanh thu phát triển ở mọi lĩnh vực.</p>
            </div><!-- end title -->
    ...
    <div id="testimonials" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Luôn mong muốn sự phục vụ tốt nhất, nên chúng tôi luôn ghi nhận những đánh giá từ phía người dùng! Những đóng góp này sẽ giúp sản phẩm của chúng tôi được hoàn thiện hơn.</p>
            </div><!-- end title -->
    ...
    <div id="purchase" class="parallax section db" style="background-image:url('/assets/user/uploads/pr_bg.jpg');">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h3>Dùng ngay!</h3>
                <p class="lead">Chúng tôi trân trọng cảm ơn những lời nhận xét từ phía người dùng. Từ những đánh giá trên giúp sản phẩm phần mềm của chúng tôi đến tay người dùng với chất lượng ngày càng nâng cao hơn!</p>
            </div><!-- end title -->
    ...
    <section class="section nopad cac text-center">
        <a href="#"><h3>Nếu có bất kì thắc mắc nào cho ứng dụng của chúng tôi chỉ cần để lại liên hệ. Đội ngũ tư vấn của chúng tôi sẽ hỗ trợ tốt nhất!</h3></a>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <p> Appfast là nền tảng giúp bạn tạo ra ứng dụng di động đơn giản, nhanh chóng mà không cần kiến thức lập trình.</p>
                        <p>Appfast tạo ứng dụng dựa trên các widget được định nghĩa sẵn cùng khả năng tùy chỉnh các thuộc tính như màu sắc, hình ảnh, liên kết...</p>
                    </div><!-- end clearfix -->
                </div><!-- end col -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="footer-distributed widget clearfix">
                        <div class="widget-title">
                            <h3>Tin mới</h3>
							<p>Để lại Email của bạn chúng tôi sẽ thông báo đến bạn khi có những cập nhật, chương trình mới từ ứng dụng</p>
                        </div>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">                    
					...
					<a href="https://html.design/">SiVi CODE</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
